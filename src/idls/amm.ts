type Amm = {
  ...
  instructions: [
    ...
    },
    {
      ...
      args: [
        { name: "tokenAAmount"; type: "u64" },
        { name: "tokenBAmount"; type: "u64" },
        { name: "activationPoint"; type: { option: "u64" } }
      ];
    },
    {
      ...
      args: [{ name: "newActivationPoint"; type: "u64" }];
    },
    {
      ...
      accounts: [
        ...
        { name: "aVaultLp"; isMut: false; isSigner: false },
    ...
    },
    {
      ...
      args: [{ name: "whitelistedVault"; type: "publicKey" }];
    }
  ];
  accounts: [
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "poolFees"; type: { defined: "PoolFees" } },
          { name: "activationDuration"; type: "u64" },
          { name: "vaultConfigKey"; type: "publicKey" },
          { name: "poolCreatorAuthority"; type: "publicKey" },
          { name: "activationType"; type: "u8" },
          { name: "padding"; type: { array: ["u8", 227] } }
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "padding0"; type: { array: ["u8", 24] } },
          {
            name: "fees";
  ...
  types: [
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "protocolTradeFeeNumerator"; type: "u64" },
          { name: "activationDuration"; type: "u64" },
          { name: "vaultConfigKey"; type: "publicKey" },
          { name: "poolCreatorAuthority"; type: "publicKey" },
          { name: "activationType"; type: "u8" },
    ...
    },
    {
      ...
      type: {
        kind: "enum";
        variants: [{ name: "Slot" }, { name: "Timestamp" }];
      };
    },
    {
      name: "RoundDirection";
  ...
  events: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "protocolTradeFeeNumerator"; type: "u64"; index: false },
        {
          name: "protocolTradeFeeDenominator";
          type: "u64";
          index: false;
    ...
    {
      name: "CloseConfig";
      fields: [{ name: "config"; type: "publicKey"; index: false }];
    },
    {
      name: "WithdrawProtocolFees";
      fields: [
        { name: "pool"; type: "publicKey"; index: false },
        { name: "protocolAFee"; type: "u64"; index: false },
        { name: "protocolBFee"; type: "u64"; index: false },
        { name: "protocolAFeeOwner"; type: "publicKey"; index: false },
        { name: "protocolBFeeOwner"; type: "publicKey"; index: false }
      ];
    }
  ];
  errors: [
    ...
    { code: 6035; name: "InvalidAdmin"; msg: "Invalid admin" },
    {
      code: 6036;
    ...
    { code: 6038; name: "InvalidFeeOwner"; msg: "Invalid fee owner" },
    { code: 6039; name: "NonDepletedPool"; msg: "Pool is not depleted" },
    { code: 6040; name: "AmountNotPeg"; msg: "Token amount is not 1:1" },
    { code: 6041; name: "AmountIsZero"; msg: "Amount is zero" },
    { code: 6042; name: "TypeCastFailed"; msg: "Type cast error" },
    {
      code: 6043;
